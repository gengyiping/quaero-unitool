...
import com.small.qcit.domain.dto.CMessage;
import com.small.qcit.domain.dto.MotorParameters;
...
@RestController
public class motorController  extends optContorller{
	@MessageMapping("/loadMotor")
	 public void loadMotor(User user) {
		 ...
		 try {
			 ...
			 successSend("/user/"+user.getIp()+"/allmotor/alone/getResponse", strs.substring(0, strs.length()-1), user);
			} catch (Exception e) {
				errorSend(e, user);
			}
	 }
	 @MessageMapping("/motorcontrol/{motorcontrol}")
	public void backMotor(@RequestBody CMessage message, @DestinationVariable("motorcontrol") String motorcontrol, User user) {
		 System.out.println("移动--------");
				try {
					if("backZero".equals(motorcontrol)){
					 ...
					 successSend("/user/"+user.getIp()+"/motorcontrol/alone/getResponse", "移动成功！", user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/getCoord")
	public void getCoord(@RequestBody String motorId, User user) {
		 System.out.println("获取当前坐标--------");
		 long coord=0;
				try {
					coord=api.getCurrentCoordinate(0, Integer.valueOf(motorId)).getCoordinate();
					successSend("/user/"+user.getIp()+"/getCoord/alone/getResponse", coord+"", user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/steplost")
	public void stepLost(@RequestBody String motorId, User user) {
		 System.out.println("获取失步数--------");
		 String mess="";
		 MotorLostStep coord=null;
				try {
					...
					successSend("/user/"+user.getIp()+"/steplost/alone/getResponse", mess, user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/motorFlag")
	public void getMotorFlag(@RequestBody String motorId, User user) {
		 System.out.println("获取电机状态--------");
		 String mess;
		   IMotorFlag coord=null;
				try {
					...
					successSend("/user/"+user.getIp()+"/motorFlag/alone/getResponse", mess, user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/sensorStop/{sensorStop}")
	public void sensorStop(@RequestBody CMessage message, @DestinationVariable("sensorStop") String sensorStop, User user) {
		...
		long coord=0;
				try {
					...
					successSend("/user/"+user.getIp()+"/sensorStop/alone/getResponse", coord+"", user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/grooveMove")
	public void grooveMove(@RequestBody CMessage message, User user) {
		 System.out.println("走计数凹槽--------");
				try {
					...
					successSend("/user/"+user.getIp()+"/grooveMove/alone/getResponse", "走计数凹槽成功！", user);
	...
	public void searchInlineopt(@RequestBody MotorParameters message, User user) {
		 ...
		 String msg="";
				try {
						...
						successSend("/user/"+user.getIp()+"/searchInlineopt/alone/getResponse", msg, user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	 }
	 @MessageMapping("/writeInlineopt")
	public void writeInlineopt(@RequestBody MotorParameters message, User user) {
		 ...
		 String msg="";
				try {
						...
						successSend("/user/"+user.getIp()+"/writeInlineopt/alone/getResponse", "写电机参数成功", user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	 }
	 @MessageMapping("/coordLimit/write")
	public void coordLimit(@RequestBody CMessage message, User user) {
		 String msg="";
				try {
						System.out.println("设置最大运行坐标--------");
						api.setMaxMotorCoordinateLimit(0, message.getMotorId(), getLimit(message.getAcce(),message.getCoord()));
						msg="完成最大运行坐标设置";
					successSend("/user/"+user.getIp()+"/writeCoordLimit/alone/getResponse", msg, user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/coordLimit/read")
	public void readCoordLimit(@RequestBody CMessage message, User user) {
		 String msg="";
				try {
						 System.out.println("获取最大运行坐标--------");
						 IMotorCoordinateLimit step=api.getMaxMotorCoordinateLimit(0, message.getMotorId());
						 msg=step.getLimitPhy()+";"+step.getLimitMax();
					successSend("/user/"+user.getIp()+"/readCoordLimit/alone/getResponse", msg, user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/outStepForm/read")
	public void readoutStepForm(@RequestBody CMessage message, User user) {
		 String msg="";
				try {
						 System.out.println("获取最大允许失步数--------");
						 MotorLostStep step=api.getMotorLostStepLimit(0,message.getMotorId());
						 msg=step.getForward()+";"+step.getReverse();
					successSend("/user/"+user.getIp()+"/readOutStepForm/alone/getResponse", msg, user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/outStepForm/write")
	public void outStepForm(@RequestBody CMessage message, User user) {
		 String msg="";
				try {
						...
						msg="完成最大允许失步数设置";
					successSend("/user/"+user.getIp()+"/writeOutStepForm/alone/getResponse", msg, user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 
	 @MessageMapping("/zeroOpt/read")
	public void readzeroOpt(@RequestBody CMessage message, User user) {
		 String msg="";
				try {
						 System.out.println("获取零位传感器值--------");
						 Coordinate coordinate= api.getMotorCoordinateZero(0,message.getMotorId());
						 msg=coordinate.getCoordinate()+"";
					successSend("/user/"+user.getIp()+"/readZeroOpt/alone/getResponse", msg, user);

				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/zeroOpt/write")
	public void writezeroOpt(@RequestBody CMessage message, User user) {
		 String msg="";
				try {
						System.out.println("设置零位传感器值--------");
						api.setMotorCoordinateZero(0,message.getMotorId(),new Coordinate(message.getCoord()));
						msg="完成零位传感器值设置";
					successSend("/user/"+user.getIp()+"/writeZeroOpt/alone/getResponse", msg, user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/createMotorFile")
	public void  createMotorFile(@RequestBody CMessage message, User user) {
		 String msg="";
				try {
						System.out.println("---------创建电机默认文件--------");
						api.createJsonFile(0,message.getMotorId());
						msg="完成"+message.getMotorId()+"号电机创建电机默认文件";
						successSend("/user/"+user.getIp()+"/createMotorFile/alone/getResponse", msg, user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	 @MessageMapping("/speedAcc/read")
	public void readspeedAcc(@RequestBody CMessage message, User user) {
		 String msg="";
				try {
						 System.out.println("获取速度加速度值--------");
						 String speed= api.getProperty(0, "Motor_qcit_location", "QCIT.MB_"+message.getMotorId()+".SpeedMax")+"";
						 String acceleration=api.getProperty(0, "Motor_qcit_location", "QCIT.MB_"+message.getMotorId()+".Acceleration")+"";
						 String resetSpeed=api.getProperty(0, "Motor_qcit_location", "QCIT.MB_"+message.getMotorId()+".ResetSpeed")+"";
						 String resetAcc=api.getProperty(0, "Motor_qcit_location", "QCIT.MB_"+message.getMotorId()+".ResetAcceleration")+"";
						 msg=speed+";"+acceleration+";"+resetSpeed+";"+resetAcc;
					successSend("/user/"+user.getIp()+"/readSpeedAcc/alone/getResponse", msg, user);
				} catch (Exception e) {
					errorSend(e, user);
				}
	    }
	    @MessageMapping("/speedAcc/write")
		public void writespeedAcc(@RequestBody CMessage message, User user) {
			 String msg="";
					try {
							System.out.println("设置速度加速度值--------");
							   api.setProperty(0, "Motor_qcit_location", "QCIT.MB_"+message.getMotorId()+".SpeedMax", message.getSpeed()+"");
								api.setProperty(0, "Motor_qcit_location", "QCIT.MB_"+message.getMotorId()+".Acceleration", message.getAcce()+"");
								api.setProperty(0, "Motor_qcit_location", "QCIT.MB_"+message.getMotorId()+".ResetSpeed", message.getResetSpeed()+"");
								api.setProperty(0, "Motor_qcit_location", "QCIT.MB_"+message.getMotorId()+".ResetAcceleration", message.getResetAcc()+"");
							api.getSpeedList();
							msg="完成速度加速度值设置";
						successSend("/user/"+user.getIp()+"/writeSpeedAcc/alone/getResponse", msg, user);
					} catch (Exception e) {
						errorSend(e, user);
					}
		    }
		 @MessageMapping("/upload")
		public void  upload(@RequestBody Fileload  file, User user) {
			 String msg="";
			 File files=null;
						...
						//String kk=getImageString(fileByte);
					        ...
					        try {  
					        	...
					        	String ipPort = api.getPropertys(0, "Ip_qcit_location", "QCIT.MB.ipPort").split(":")[0];
					        	if(!"".equals(ipPort)){
									...
									if(cmdflag == true){
										msg="上传电机文件成功";
								    	successSend("/user/"+user.getIp()+"/upload/alone/getResponse", msg, user);
								    }else{
								    	msg="上传电机文件失败,请重新上传";
								    	successSend("/user/"+user.getIp()+"/upload/alone/getResponse", msg, user);
								    }
...
//	 @SendTo("/user/"+user.getIp()+"/allmotor/alone/getResponse")
...
//	 @MessageMapping("/motorcontrol/{motorcontrol}")
//	 @SendTo("/user/"+user.getIp()+"/motorcontrol/alone/getResponse")
//	public String backMotor(@RequestBody CMessage message, @DestinationVariable("motorcontrol") String motorcontrol, Principal principal) {
...
//	 @MessageMapping("/getCoord")
//	 @SendTo("/user/"+user.getIp()+"/getCoord/alone/getResponse")
...
//	    }
//	 @MessageMapping("/steplost")
//	 @SendTo("/user/"+user.getIp()+"/steplost/alone/getResponse")
...
//	 @MessageMapping("/motorFlag")
//	 @SendTo("/user/"+user.getIp()+"/motorFlag/alone/getResponse")
...
//	    }
//	 @MessageMapping("/sensorStop/{sensorStop}")
//	 @SendTo("/user/"+user.getIp()+"/sensorStop/alone/getResponse")
//	public String sensorStop(@RequestBody CMessage message, @DestinationVariable("sensorStop") String sensorStop, Principal principal) {
//		 System.out.println("获取传感器停--------");
//		long coord=0;
//				try {
//					if("moveSensorStop".equals(sensorStop)){
...
//	    }
//	 @MessageMapping("/grooveMove")
//	 @SendTo("/user/"+user.getIp()+"/grooveMove/alone/getResponse")
//	public String grooveMove(@RequestBody CMessage message, Principal principal) {
//		 System.out.println("走计数凹槽--------");
//				try {
//					api.motorPositMove(0, Integer.valueOf(message.getMotorId()),new Coordinate(message.getCoord()), Integer.valueOf(message.getSensorId()));
//				} catch (Exception e) {
...
//	 @MessageMapping("/searchInlineopt")
//	 @SendTo("/user/"+user.getIp()+"/searchInlineopt/alone/getResponse")
...
//	 }
//	 @MessageMapping("/writeInlineopt")
//	 @SendTo("/user/"+user.getIp()+"/writeInlineopt/alone/getResponse")
...
//	 @SendTo("/user/"+user.getIp()+"/coordLimit/alone/getResponse")
//	public String coordLimit(@RequestBody CMessage message, @DestinationVariable("opt") String opt, Principal principal) {
//		
//		 String msg="";
//				try {
//					if("read".equals(opt)){
...
//	 @SendTo("/user/"+user.getIp()+"/outStepForm/alone/getResponse")
//	public String outStepForm(@RequestBody CMessage message, @DestinationVariable("opt") String opt, Principal principal) {
//		 String msg="";
//				try {
//					if("read".equals(opt)){
//						 System.out.println("获取最大允许失步数--------");
...
//	 @SendTo("/user/"+user.getIp()+"/zeroOpt/alone/getResponse")
//	public String zeroOpt(@RequestBody CMessage message, @DestinationVariable("opt") String opt, Principal principal) {
//		 String msg="";
//				try {
//					if("read".equals(opt)){
//						 System.out.println("获取零位传感器值--------");
...
//	    }
//	 @MessageMapping("/createMotorFile")
//	 @SendTo("/user/"+user.getIp()+"/createMotorFile/alone/getResponse")
//	public String  createMotorFile(@RequestBody CMessage message, Principal principal) {
//		 String msg="";
//				try {
//						System.out.println("---------创建电机默认文件--------");
//						api.createJsonFile(0,message.getMotorId());
...
//	 @SendTo("/user/"+user.getIp()+"/speedAcc/alone/getResponse")
//	public String speedAcc(@RequestBody CMessage message, @DestinationVariable("opt") String opt, Principal principal) {
//		 String msg="";
//				try {
//					if("read".equals(opt)){
//						 System.out.println("获取速度加速度值--------");
