      ...
      <div class="containerContent" title="进样测试" style="width:auto; height:auto;">  
           <table style="margin-top: 20px;">
              <tr>
                  ...
                  <td colspan="">&emsp;<el-input v-model="ruleForm.phoneNum"></el-input></td>
             <tr>
              <tr>
               <td colspan="8" rowspan="20">
                 <el-input type="textarea" style="width:500px; height:450px;" id="desces" v-model="desc" :rows="20" ></el-input>
               </td>
             </tr>
