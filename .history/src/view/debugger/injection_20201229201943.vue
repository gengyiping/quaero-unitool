...
export default {
  ...
  // reader.readAsArrayBuffer(fil);
    ...
    reader.onload = function()
    {
        debugger
        text=reader.result
        console.log("读出的大小"+text.length)
        var result = [];//将二进制字符串转换成Unicode字符串
         var list = text.split(" ");
         ...
         result.push(charValue);
          ...
          debugger
         var arrayBufferData= result.join("");
      ...
      //       const fileHead1 = bytes.slice(0, 40);
          ...
          // console.log("arrayBufferData"+arrayBufferData.byteLength)
          ...
          str=text
            ...
            var sleeptime=-1
             //_this.sendLoad(imgName,n,0,knum,str)
