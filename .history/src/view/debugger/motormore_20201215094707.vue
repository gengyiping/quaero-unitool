                        ...
                        <el-form :model="outStepForm" :rules="rules" ref="outStepForm" label-width="100px" class="demo-ruleForm" style="margin-top: 20px;">
                             <table>
                                 <tr>
                                   ...
                                   <td class="tdpad">
                                      <el-row>
                                        <el-button type="primary"  @click="readOutMove(outStepForm,'read')" plain>读取</el-button>
                                      </el-row>
                                   </td>
                                 </tr>
                                 <tr>
                                   ...
                                   <td class="tdpad">
                                      <el-row>
                                        <el-button type="primary"  @click="writeOutMove(outStepForm,'write')" plain>写入</el-button>
                                      </el-row>
                                   </td>
                                 </tr>
                               </table>
