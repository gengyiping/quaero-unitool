           ...
           <table>
             ...
             <tr>
              ...
              <tr>
                ...
                <td>
                  <el-button type="primary" @click="readParm(0)" plain>读取本地定标参数</el-button>
               </td>
               <td>
              ...
              <tr>
                 <td>
                 <el-button type="primary" @click="readCoord(1)" plain>读取设备定标</el-button>
               </td>
               <td>
                  <el-button type="primary" @click="readParm(1)" plain>读取设备定标参数</el-button>
               </td>
               <td>
                 <el-button type="primary" @click="writeCoord(0)" plain>保存设备定标</el-button>
               </td>
               <td>
                  <el-button type="primary" @click="writeCoord(0)" plain>保存设备定标参数</el-button>
               </td>
             </tr>
           </table>
         </el-radio-group>
...
export default {
  ...
  methods: {
     handleSelect(key, keyPath) {
      ...
      readParm(opt){//0 读取参数 ;1读取设备坐标参数
         this.getCoordPoint()
          this.stompClient.send('/app/readCoord/'+opt+'/'+this.coodPoint)
      },
      readCoord(opt){//0 读取坐标 ;1读取设备坐标
         this.getCoordPoint()
