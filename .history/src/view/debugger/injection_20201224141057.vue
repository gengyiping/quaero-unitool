<template>
  <div class="" > 
      <div style="width:100%;height:600px;background: rgb(238, 255, 247);">
         <div class="container" title="基本操作" style="width:300px; height:auto; float:left;">
           <table class="basetable" >
             <tr>
               <td><el-button type="primary"  @click="allRest(5)" style="width: 126px;" plain>整机复位</el-button></td>
               <td><el-button type="primary" style="width: 126px;" @click="basket()" plain>提篮在线确认</el-button></td>
             </tr>
              <tr>
             ...
             <tr>
              ...
              <tr>
               ...
               <td><el-button type="primary" @click="getChip()" style="width: 126px;"    plain>获取芯片ID</el-button></td>
             </tr>
              <tr>
