      ...
      <div style="width:100%;height:560px;background: rgb(238, 255, 247);">
         ...
         <el-radio-group v-model="radio"  style="margin-top:10px">
           <table>
             <tr>
               <td>
                 <el-radio :label="1" class="inradio"  style="width: 196px !important;"  border>进样电机推试管到底&emsp;&emsp;&nbsp;</el-radio><!-- Qcit.MB.injection -->
               </td>
               <td>
                 <el-radio :label="2" class="inradio" style="width: 275px !important;" border>进样电机推试管至进样样本架出口检测</el-radio><!-- Qcit.MB.emergency -->
               </td>
               <td>
                  <el-radio :label="3" class="inradio" style="width: 210px !important;" border>急诊至进样入口&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.intTransport -->
               </td>
               <td>
                 <el-radio :label="4" class="inradio" style="width: 224px !important;" border>转移仓至扫码等待区&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.intTrack -->
               </td>
             </tr>
              <tr>
               <td>
                 <el-radio :label="5" class="inradio"  style="width: 196px !important;"  border>扫码转移电机移动距离</el-radio><!-- Qcit.MB.outTrack -->
               </td>
               <td>
                 <el-radio :label="6" class="inradio" style="width: 275px !important;" border>转移电机推试管至进样皮带&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.outTrack -->
               </td>
                <td>
                 <el-radio :label="7" class="inradio" style="width: 210px !important;" border>进样皮带入口至入口检测</el-radio><!-- Qcit.MB.outTrack -->
               </td>
               <td>
                 <el-radio :label="8" class="inradio"  style="width: 224px !important;" border>进样皮带入口检测至换轨车</el-radio><!-- Qcit.MB.outTrack -->
               </td>
             </tr>
             <tr>
               <td>
                 <el-radio :label="9" class="inradio"  style="width: 196px !important;" border>进样皮带至返回皮带&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.outTrack -->
               </td>
               <td>
                 <el-radio :label="10" class="inradio" style="width: 275px !important;" border>返回皮带入口至递进初始位&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.outTrack -->
               </td>
               <td>
                 <el-radio :label="11" class="inradio" style="width: 210px !important;" border>递进初始位&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.outTrack -->
               </td>
              <td>
                 <el-radio :label="12" class="inradio" style="width: 224px !important;" border>递进一格&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.progressive -->
               </td>
             </tr>
              <tr>
               <td>
                  <el-radio :label="13" class="inradio"  style="width: 196px !important;" border>递进收起&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.stepbyStep -->
               </td>
                <td>
                 <el-radio :label="14" class="inradio" style="width: 275px !important;" border>递进-回收入口&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.inrecovery -->
               </td>
                <td>
                  <el-radio :label="15" class="inradio" style="width: 210px !important;" border>回收入口-回收卸载&emsp;&emsp;&emsp;</el-radio> <!-- Qcit.MB.recoveryUnload -->
               </td>
                 <td>
                   <el-radio :label="16" class="inradio" style="width: 224px !important;" border>试管宽度&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio> <!-- Qcit.MB.recoveryUnload --> 
                   </td>
             </tr>
             <tr>
               <td>
               ...
               <td>
                  <el-button type="primary" @click="loadCoord(1)" plain>一键上传设备参数至设备</el-button>
               </td>
             </tr>
              <tr>
                 <td>
...
export default {
  ...
  methods: {
     handleSelect(key, keyPath) {
      ...
      loadCoord(opt){
         this.stompClient.send('/app/loadCoord/'+this.coodPoint)
      },
      getCoordPoint(){
        debugger
