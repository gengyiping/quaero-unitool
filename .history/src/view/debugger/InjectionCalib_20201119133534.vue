         ...
         <el-radio-group v-model="radio"  style="margin-top:10px">
           <table>
             <tr>
               ...
               <td>
                 <el-radio :label="2" class="inradio" border>进样电机推试管至试管数量检测点&emsp;&emsp;&nbsp;</el-radio><!-- Qcit.MB.emergency -->
               </td>
             </tr>
              <tr>
               <td>
                  <el-radio :label="3" class="inradio" border>急诊-进样入口</el-radio><!-- Qcit.MB.intTransport -->
               </td>
               <td>
