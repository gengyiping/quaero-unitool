             ...
             <el-form :model="sensorsearchForm" :rules="rules" ref="sensorsearchForm" label-width="273px" class="demo-ruleForm" style="margin-top: 20px;">
              <table style="margin-top:10px">
                <tr>
                  ...
                  <td><el-input v-model="sensorForm.sensor1" placeholder="请查询结果"></el-input></td>
                  <td>进样提篮检测(篮体)<br/>[D2-R2]</td>
                  <td><el-input v-model="sensor2" placeholder="请查询结果"></el-input></td>
                </tr>
                 <tr>
                  <td>样本架出篮口检测<br/>[D3-R3]</td>
                  <td><el-input v-model="sensor3" placeholder="请查询结果"></el-input></td>
                  <td>转移电机序号<br/>[D4-S3]</td>
                  <td><el-input v-model="sensor4" placeholder="请查询结果"></el-input></td>
                </tr>
                 <tr>
                  <td>回收仓电机序号<br/>[D6-S6]</td>
                  <td><el-input v-model="sensor6" placeholder="请查询结果"></el-input></td>
                  <td>回收提篮检测(提手)<br/>[D7-R4]</td>
                  <td><el-input v-model="sensor7" placeholder="请查询结果"></el-input></td>
                </tr>
                 <tr>
                  <td>回收提篮检测(篮体)<br/>[D8-R5]</td>
                  <td><el-input v-model="sensor8" placeholder="请查询结果"></el-input></td>
                  <td>样本架进篮检测<br/>[D9-R6]</td>
                  <td><el-input v-model="sensor9" placeholder="请查询结果"></el-input></td>
                </tr>
                 <tr>
                  <td>样本架满检测<br/>[D10-R7]</td>
                  <td><el-input v-model="input" placeholder="请查询结果"></el-input></td>
                  <td>进样样本架入口检测[D12-R8]</td>
                  <td><el-input v-model="sensor8" placeholder="请查询结果"></el-input></td>
                </tr>
                 <tr>
                  <td>进样样本架出口检测[D13-R9]</td>
                  <td><el-input v-model="sensor13" placeholder="请查询结果"></el-input></td>
                  <td>回收样本架入口检测[D14-R10]</td>
                  <td><el-input v-model="sensor14" placeholder="请查询结果"></el-input></td>
                </tr>
                 <tr>
                  <td>回收样本架出口检测[D15-R11]</td>
                  <td><el-input v-model="sensor15" placeholder="请查询结果"></el-input></td>
                  <td>递进电机序号[D16-S8]</td>
                  <td><el-input v-model="sensor16" placeholder="请查询结果"></el-input></td>
                </tr>
                 <tr>
                  <td>递进跟随到位检测[D17-R12]</td>
                  <td><el-input v-model="sensor17" placeholder="请查询结果"></el-input></td>
                  <td>换轨电机序号<br/>[D18-S10]</td>
                  <td><el-input v-model="sensor18" placeholder="请查询结果"></el-input></td>
                </tr>
                 <tr>
                  <td ></td>
                  <td >
