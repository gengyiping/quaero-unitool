      ...
      <div style="width:1080px;height:1030px;background: rgb(238, 255, 247);">
         ...
         <el-radio-group v-model="radio"  style="margin-top:10px">
           <table>
             <tr>
               <td>
                 <el-radio :label="1" class="inradio" title="QCIT.Config.InjectionMax"  style="width: 220px !important;"  border>进样电机推试管到底&emsp;&emsp;&nbsp;</el-radio><!-- Qcit.MB.injection -->
               </td>
               <td>
               ...
               <td>
                 <el-radio :label="4" class="inradio" title="QCIT.Config.InScan" style="width: 224px !important;" border>转移仓至扫码等待区&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.intTrack -->
               </td>
             </tr>
              <tr>
               <td>
                 <el-radio :label="5" class="inradio" title="QCIT.Config.ScanCode"  style="width: 220px !important;"  border>扫码转移电机移动距离</el-radio><!-- Qcit.MB.outTrack -->
               </td>
               <td>
             ...
             <tr>
              ...
              <tr>
               <td>
                  <el-radio :label="13" class="inradio" title="QCIT.Config.iProStop"  style="width: 220px !important;" border>递进收起&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.stepbyStep -->
               </td>
                <td>
