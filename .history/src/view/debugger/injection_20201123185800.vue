           ...
           <table class="basetable" style="margin-top:10px">
             ...
             <tr>
              ...
              <tr>
               ...
               <td><el-button type="primary" style="width: 126px;" @click="transferMove()" plain>开启固件更新</el-button></td>
             </tr>
             <tr>
               <td colspan="2">
                  <div>
                      <input type="file" @change="firfileChange"> 
                        <el-button type="primary" size="mini" @click="clicks">固件更新</el-button>
...
export default {
  ...
  methods: {
    ...
    reader.onload = function()
    {
        ...
        document.getElementById("firdd").innerHTML += "<input id='upfirfile' value='"+text+"'>"
    } 
    },
     firclicks() {
      debugger
