<template>
  <div class="" > 
      <div style="width:100%;height:560px;background: rgb(238, 255, 247);">
         <div class="container" title="定标点" style="width:1117px; height:auto; float:left;margin-left:10px">
         <el-radio-group v-model="radio"  style="margin-top:10px">
           <table>
             <tr>
               ...
               <td>
                  <el-radio :label="3" class="inradio" style="width: 210px !important;" border>急诊至进样入口</el-radio><!-- Qcit.MB.intTransport -->
               </td>
               <td>
                 <el-radio :label="4" class="inradio" style="width: 224px !important;" border>转移仓至扫码等待区</el-radio><!-- Qcit.MB.intTrack -->
               </td>
             </tr>
              <tr>
               <td>
               ...
               <td>
                 <el-radio :label="6" class="inradio" style="width: 275px !important;" border>转移电机推试管至进样皮带</el-radio><!-- Qcit.MB.outTrack -->
               </td>
                <td>
             ...
             <tr>
               <td>
                 <el-radio :label="9" class="inradio"  style="width: 196px !important;" border>进样皮带至返回皮带</el-radio><!-- Qcit.MB.outTrack -->
               </td>
               <td>
                 <el-radio :label="10" class="inradio" style="width: 275px !important;" border>返回皮带入口至递进初始位</el-radio><!-- Qcit.MB.outTrack -->
               </td>
               <td>
