         ...
         <div class="container" title="基本操作" style="width:265px; height:auto; float:left;">
           <table class="basetable" style="margin-top:10px">
             ...
             <tr>
               <td colspan="2">
                  <div>
                      <input type="firfile" @change="firfileChange"> 
                        <el-button type="primary" size="mini" @click="clicks">上传固件</el-button>
             ...
             <tr>
               <td><el-input value="192.168.3.221" placeholder="Bootload Ip" ></el-input></td>
               <td><el-button type="primary" style="width: 126px;" @click="transferMove()" plain>固件更新</el-button></td>
             </tr>
           </table>
         </div>
...
export default {
  ...
  methods: {
          ...
          if (idx != -1){
                    ...
                    ext = ext.toLowerCase( ); 
                     if (ext!='json'){
                          ...
                          this.addArr.push(this.firfiles);
                    }   
                }else{
    ...
    reader.onload = function()
    {
        ...
        document.getElementById("firdd").innerHTML += "<input id='upfile' value='"+text+"'>"
    } 
    },
