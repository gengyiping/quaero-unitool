      ...
      <div style="width:100%;height:560px;background: rgb(238, 255, 247);">
         ...
         <el-radio-group v-model="radio"  style="margin-top:10px">
           <table>
             ...
             <tr>
               <td>
                 <el-radio :label="9" class="inradio" title="定标点"  style="width: 196px !important;" border>进样皮带至返回皮带&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.outTrack -->
               </td>
               <td>
               ...
               <td>
                 <el-radio :label="11" class="inradio" title="定标点" style="width: 210px !important;" border>递进初始位&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.outTrack -->
               </td>
              <td>
                 <el-radio :label="12" class="inradio" title="定标点" style="width: 224px !important;" border>递进一格&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.progressive -->
               </td>
             </tr>
              <tr>
               <td>
                  <el-radio :label="13" class="inradio" title="定标点"  style="width: 196px !important;" border>递进收起&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.stepbyStep -->
               </td>
                <td>
                 <el-radio :label="14" class="inradio" title="定标点" style="width: 275px !important;" border>递进-回收入口&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.inrecovery -->
               </td>
                <td>
