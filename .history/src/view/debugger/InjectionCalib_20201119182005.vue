...
export default {
  ...
  methods: {
    ...
    handleAddItem() { 
      var _this = this;// `这一步很重要`
      _this.motorinfo= this.$refs.multipleTable.selection
     for(var i=0;i< _this.motorinfo.length;i++){
        debugger
       this.stompClient.send('/app/searchMotor/'+ _this.motorinfo[i].motorId)
