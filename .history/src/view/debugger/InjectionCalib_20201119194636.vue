  ...
  methods: {
    ...
    handleAddItem() { 
     ...
     var kk= this.$refs.multipleTable.selection
      ...
      //       for(let key in obj) {
      //                         if(key=='forward')_this.motorinfo.forward =obj[key]
      //                         if(key=='reverse')_this.motorinfo.reverse=ob1[key]
      //                         if(key=='zeroFlag')_this.motorinfo.zero=obj[key]
      //                         if(key=='zero')_this.motorinfo.zeroCoord=obj[key]
      //                         if(key=='coord')_this.motorinfo.coord=obj[key]
      //      }
      //      kk=_this.motorinfo
      //    })
        ...
        //     for(let key in obj) {
        //                       if(key=='forward')kk[i].forward =obj[key]
        //                       if(key=='reverse')kk[i].reverse=ob1[key]
        //                       if(key=='zeroFlag')kk[i].zero=obj[key]
        //                       if(key=='zero')kk[i].zeroCoord=obj[key]
        //                       if(key=='coord')kk[i].coord=obj[key]
        //    }
        // })
     }
