         ...
         <el-radio-group v-model="radio"  style="margin-top:10px">
           <table>
             ...
             <tr>
              ...
              <tr>
                 <td>
                 <el-button type="primary"  plain>读取本地定标</el-button>
               </td>
                <td>
                  <el-button type="primary" @click="readParam(0)" plain>读取本地定标参数</el-button>
               </td>
               <td>
              ...
              <tr>
               ...
               <td>
                  <el-button type="primary" @click="readParam(1)" plain>读取设备定标参数</el-button>
               </td>
               <td>
...
export default {
  ...
  methods: {
     handleSelect(key, keyPath) {
      ...
      readParam(opt){//0 读取参数 ;1读取设备参数
         var _this = this;// `这一步很重要`
         this.getCoordPoint()
          this.stompClient.send('/app/readParam/'+opt+'/'+this.coodPoint)
      },
      readCoord(){
         this.getCoordPoint()
      ...
      getCoordPoint(){
        debugger
         ...
         <Tubewidth>1185</Tubewidth>  
    <Injection>25900</Injection>  
    <InjectionMax>29390</InjectionMax>  
    <emergency>2700</emergency> 
    <InScan>1000</InScan>  
    <ScanCode>10000</ScanCode>  
    <Transfer>11111</Transfer>  
    <InBelt>30000</InBelt>  
    <BeltToTrack>44444</BeltToTrack>  
    <TrackToBackBelt>2000</TrackToBackBelt>  
    <iProgInit>296</iProgInit>  
    <TrackToProg>12222</TrackToProg>  
    <iProToOne>1367</<iProToOne>  
    <iProStop>7100</iProStop>  
    <backOver>2500</<backOver> 
      },
