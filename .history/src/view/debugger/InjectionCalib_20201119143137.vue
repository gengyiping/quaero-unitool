           ...
           <table>
             ...
             <tr>
              ...
              <tr>
               ...
               <td>
                 <el-button type="primary"  @click="readCoord(6)" plain>保存本地定标</el-button>
               </td>
               <td>
                  <el-button type="primary" @click="readCoord(4)" plain>保存本地定标参数</el-button>
               </td>
             </tr>
              <tr>
                 <td>
               ...
               <td>
                 <el-button type="primary" @click="readCoord(7)" plain>保存设备定标</el-button>
               </td>
               <td>
                  <el-button type="primary" @click="readCoord(5)" plain>保存设备定标参数</el-button>
               </td>
             </tr>
           </table>
         </el-radio-group>
