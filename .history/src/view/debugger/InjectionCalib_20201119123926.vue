      ...
      <div style="width:100%;height:560px;background: rgb(238, 255, 247);">
         ...
         <el-radio-group v-model="radio"  style="margin-top:10px">
           <table>
             <tr>
               <td>
                 <el-radio :label="1" class="inradio"   border>进样电机行程最大行程&emsp;&emsp;&nbsp;</el-radio><!-- Qcit.MB.injection -->
               </td>
               <td>
             ...
             <tr>
               ...
               <td>
                  <el-button type="primary" plain>读取本地定标参数</el-button>
               </td>
             </tr>
              <tr>
               <td>
                 <el-button type="primary" plain>保存本地定标</el-button>
               </td>
               <td>
                  <el-button type="primary" plain>保存本地定标参数</el-button>
               </td>
             </tr>
              <tr>
               <td>
