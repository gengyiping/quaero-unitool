               ...
               for(var i=0;i<kk.length;i++){
                   if(kk[i].motorId==key){
                         for(let key1 in obj[key]) {
                              if(key1==forward)kk[i].forward =obj[key]
                              if(key1==reverse)kk[i].reverse=obj[key]
                              if(key1==zeroFlag)kk[i].zero=obj[key]
                              if(key1==zero)kk[i].zeroCoord=obj[key]
                              if(key1==coord)kk[i].coord=obj[key]
           }
                         }
                   }
               }
