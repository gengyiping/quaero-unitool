...
　　　　</template>
     ...
     <el-table-column
      ...
      width="40" >
            <template slot-scope="scope">
　　　　　　<el-button type="text" @click="checkDetail(scope.row.motorId,2)">GO</el-button>
　　　　</template>
    </el-table-column>
     <el-table-column
      prop=""
      ...
      width="75">
            <template slot-scope="scope">
　　　　　　<el-button type="text" @click="checkDetail(scope.row.motorId,3)">SeekZero</el-button>
　　　　</template>
    </el-table-column>
     <el-table-column
      prop=""
      ...
      width="65" show-overflow-tooltip>
            <template slot-scope="scope">
　　　　　　<el-button type="text" @click="checkDetail(scope.row.motorId,4)">Reset</el-button>
　　　　</template>
    </el-table-column>
  </el-table>
   </div>
