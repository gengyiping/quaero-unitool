         ...
         <el-radio-group v-model="radio"  style="margin-top:10px">
           <table>
             ...
             <tr>
              ...
              <tr>
                 <td>
                 <el-button type="primary" @click="readCoord(3)"  plain>读取本地定标</el-button>
               </td>
                <td>
               ...
               <td>
                  <el-button type="primary" @click="readParm(0)" plain>保存本地定标参数</el-button>
               </td>
             </tr>
              <tr>
                 <td>
                 <el-button type="primary" @click="readCoord(4)" plain>读取设备定标</el-button>
               </td>
               <td>
