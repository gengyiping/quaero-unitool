      ...
      <div style="width:1080px;height:1030px;background: rgb(238, 255, 247);">
         ...
         <el-radio-group v-model="radio"  style="margin-top:10px">
           <table>
             ...
             <!-- <tr>
               <td>
                  <el-radio :label="17" class="inradio" title="QCIT.Config.initPosition"  style="width: 220px !important;" border>换轨初始位&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</el-radio><!-- Qcit.MB.stepbyStep -->
               </td>
                <td>
               </td>
                <td>
