  ...
  <div class="" > 
      <div style="width:100%;height:560px;background: rgb(238, 255, 247);">
         ...
         <el-radio-group v-model="radio"  style="margin-top:10px">
           <table>
             ...
             <tr>
               ...
               <td>
                 <el-radio :label="9" class="inradio" border>递进初始位</el-radio><!-- Qcit.MB.outTrack -->
               </td>
              <td>
        ...
        <div></div>
         ...
         <div class="container" title="电机控制" style="width:1024px; height:auto; float:left;margin-left:10px">
