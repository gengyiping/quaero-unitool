     ...
     sub(){
       ...
       var _this=this
        ...
        _this.stompClient.subscribe('/user/writeZeroOpt/alone/getResponse', function (val) {
         ...
         _this.stompClient.subscribe('/user/readSpeedAcc/alone/getResponse', function (res) {
            console.log("----speedAcc----")
             _this.getData(val.body)
                    Bus.$emit('speedAccList',_this.returnobj.message)
        });
        _this.stompClient.subscribe('/user/writeSpeedAcc/alone/getResponse', function (res) {
            console.log("----speedAcc----")
             _this.getData(val.body)
                  _this.$message('success:' + _this.returnobj.message)
        });
         _this.stompClient.subscribe('/user/upload/alone/getResponse', function (res) {
