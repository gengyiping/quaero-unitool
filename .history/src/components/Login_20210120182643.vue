       ...
       var _this=this
        ...
        this.stompClient.connect(userinfo, function (frame) {
          ...
          _this.stompClient.subscribe('/user/'+_this.iplocal+'/initInfo/alone/getResponse', (val) => {//连接信息
           ...
           _this.stompClient.subscribe('/user/'+_this.iplocal+'/setbarCode/alone/getResponse', (val) => {//连接信息
              _this.getData(val.body)
              _this.$store.state.initInfo=_this.returnobj.message
          });
        ...
        _this.stompClient.subscribe('/user/'+_this.iplocal+'/writeEquipment/alone/getResponse', (val) => {//写入设备Ip信息
         ...
         _this.stompClient.subscribe('/user/'+_this.iplocal+'/openscan/alone/getResponse', (val) => {//开启事件日志
             console.log(val.body)
             _this.getData(val.body)
        ...
        _this.stompClient.subscribe('/user/'+_this.iplocal+'/readZeroOpt/alone/getResponse', function (val) {
