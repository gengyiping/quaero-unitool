     ...
     sub(){
       ...
       var _this=this
        ...
        _this.stompClient.subscribe('/user/searchMotor/alone/getResponse', function (val) {//查询所有电机信息
         ...
         _this.stompClient.subscribe('/user/motorOpt/alone/getResponse', function (res) {//电机信息电机控制
              _this.getData(val.body)
             _this.$message('success:' + _this.returnobj.message)
        });
         _this.stompClient.subscribe('/user/motorcontrol/alone/getResponse', function (res) {//电机界面电机控制
