  ...
  methods: {
    ...
    loginSubmit(){
      ...
      if(this.$store.state.stompClient==''){//没有连接创建连接
         ...
         var data =this.$cookieStore.getCookie('user')
         if( _this.loginform.userName!=datas[0] || _this.loginform.userName!=datas[1] || _this.loginform.projectName !=datas[2]){
             this.stompClient.on('disconnect', function () {
               debugger
               console.log('disconnect client event....');
                _this.loginSubmit()
             });
         }else if( _this.loginform.userName==datas[0] && _this.loginform.userName==datas[1] && _this.loginform.projectName ==datas[2]){
