...
//  },
  mounted() {
    this.getIpPort('./../static/Text/Ip.text')
     this.loaduser()
    //this.init()//初始化连接
    var that = this;
    // Bus.$off('loadinit')
  ...
  methods: {
    ...
    // });
    //                 /*../../请根据自己的实际路径来获取*/
    //  newInstance.get('./../static/Json/Ip.json').then(res => {
    //    debugger
...
debugger
    ...
    loginSubmit(){//
        const socket = new SockJS('http://'+socketUrl+'/webSocket')
