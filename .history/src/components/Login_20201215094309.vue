    ...
    config() {
     ...
     sub(){
       ...
       var _this=this
        ...
        _this.stompClient.subscribe('/user/readCcoordLimit/alone/getResponse', function (val) {
            console.log("----coordLimit----")
              _this.getData(val.body)
                var op= _this.returnobj.message.split(';')
                if(op[2]=='read'){
         ...
         _this.stompClient.subscribe('/user/writeCcoordLimit/alone/getResponse', function (val) {
            console.log("----coordLimit----")
              _this.getData(val.body)
                var op= _this.returnobj.message.split(';')
                if(op[2]=='read'){
