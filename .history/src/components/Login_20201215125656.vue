...
debugger
    ...
    config() {
     ...
     sub(){
       ...
       _this.stompClient.subscribe('/user/testMoveone/alone/getResponse', function (res) {//测试流程
         debugger
                   _this.getData(val.body)
                  Bus.$emit('testMoveone',_this.returnobj.message);
        });
         _this.stompClient.subscribe('/user/scanBarcode/alone/getResponse', function (res) {//监听扫码
         debugger
