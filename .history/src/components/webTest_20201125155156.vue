<template>
  ...
  <span slot="footer" class="dialog-footer">
     ...
     <div id='ip' ></div>
     <h1>{{ ip }}</h1>
     <div class="test" v-html="Ip.hmtl"></div>
     <!-- <iframe name = "child" id = "child" :src='Ip.hmtl' width="1920" height="880" frameborder="0" scrolling="no" style="position:related;top: 2.8px;left: 0px;"></iframe> -->
