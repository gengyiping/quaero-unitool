  ...
  <span>信息栏</span>
    <el-scrollbar
            ...
            <div
              ...
              <!-- <div v-for="i in infolabel" :key="i" class="infinite-list-item">{{ infolabel }}</div> -->
          <div v-for="(item,index) in infolabel" :key="item" class="infinite-list-item">{{ infolabel }}</div>
