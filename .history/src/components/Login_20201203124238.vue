<template>
  ...
  <el-form-item label="活动区域">
    <el-select v-model="1" placeholder="请选择活动区域">
      <el-option label="区域一" value="shanghai"></el-option>
      <el-option label="区域二" value="beijing"></el-option>
    </el-select>
  </el-form-item>
   </el-form>
               <el-input  placeholder="请在此处输入您的昵称！" style="width:300px"></el-input>
               <el-input  placeholder="请在此处输入密码！" style="width:300px"></el-input>
            </div>
           
            <!-- <div class="login-name"></div>
           <input type="text" id="username" placeholder="请在此处输入您的昵称！" class="form-control">
            <button type="button" class="btn btn-primary" id="joinChat">登入&nbsp;→</button>
