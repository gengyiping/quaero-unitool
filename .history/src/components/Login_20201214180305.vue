     ...
     sub(){
       ...
       var _this=this
        ...
        _this.stompClient.subscribe('/user/deleteCoord/alone/getRespons', function (val) {//删除设备参数
         ...
         _this.stompClient.subscribe('/user/writeCoord/alone/getResponse', function (res) {//保存定标参数
              _this.getData(val.body)
             _this.$message('success:' + _this.returnobj.message)
        });
         _this.stompClient.subscribe('/user/allmotor/alone/getResponse', function (res) {//查询所有电机
