     ...
     <div style="width:100%;background:#40E0D0">
       ...
       <i class="el-icon-video-pause" style="font-size: 45px; color: #DC143C" v-if="closeshow"></i>
        ...
        <span style="float: right;" v-if="infoshow">
         <i class="el-icon-d-arrow-left" style="font-size: 45px; color: #7FFF00;"></i> 
        </span>
        <span style="float: right;" v-if="infocshow">
         <i class="el-icon-d-arrow-right" style="font-size: 45px; color: #7FFF00;"></i> 
        </span>
